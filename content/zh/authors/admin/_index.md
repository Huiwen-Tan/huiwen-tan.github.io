...
education:
  - area: 化学哲学硕士
    ...
    date_end: 2027-06-30
    summary: |
      - 课程：超分子化学；金属有机化学与催化；从计算物理到人工智能
  - area: 高级理学学士（化学荣誉学位）
    institution: 昆士兰大学
    date_start: 2020-02-01
    date_end: 2024-12-13
    summary: |
      - 荣誉学位论文：用机器学习力场建模自旋交叉晶格
      - 奖项与荣誉：一等荣誉学位；学术优秀表现院长嘉奖（2020、2024）；2022/23年暑期研究项目奖学金


work:
  - position: 助教
    company_name: 香港中文大学
    company_url: https://www.cuhk.edu.hk/chinese/index.html
    company_logo: ''
...
欢迎来到我的主页！我是[香港中文大学化学系](https://chem.cuhk.edu.hk/)的在读哲学硕士生。目前，我的研究重点是开发计算化学工具来自动化工作流程和加速化学发现。
